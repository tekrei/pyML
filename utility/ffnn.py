...
from .functions import CrossEntropyCost, sigmoid, sigmoid_prime, vectorized_result
...
class Network(object):
    ...
    def SGD(
        ...
        for j in range(epochs):
            ...
            print(f"Epoch {j+1}/{epochs} training complete in {time()-start} seconds")
    ...
    def accuracy(self, data, convert=False):
        ...
        representations can be found in prepare_data.
        """
        if convert:
            results = [
